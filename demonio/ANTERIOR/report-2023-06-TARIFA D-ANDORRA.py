...
def genStamp(tarifa, fecha, evento, codigo, c):
	...
	#drawText(evento, "FranklinGothic", 9, 1.5*mm, 14*mm-7*mm, c) - O R I G I N A L = 9 y 1.5
	drawText(evento, "FranklinGothic", 8, 1.5*mm, 14*mm-7*mm, c)
				...
				if productos[index]["idProducto"] == "tarifaAT1" or productos[index]["idProducto"] == "tarifaAT2":
					...
					for x in xrange(0,item["cantidad"]):
						if modelo==1:
							...
							id_producto = int(id_producto) + 1
							ct[modelo-1].showPage()
							genStampI(modelo1_ticket, "Tarifa D", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), ct[modelo-1])
							id_producto = int(id_producto) + 1
							ct[modelo-1].showPage()	
						else:
							genStampD(modelo2_ticket, "Tarifa A", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), ct[modelo-1])
							...
							id_producto = int(id_producto) + 1
							ct[modelo-1].showPage()
							genStampD(modelo2_ticket, "Tarifa D", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), ct[modelo-1])
							id_producto = int(id_producto) + 1
							ct[modelo-1].showPage()		
			...
			if productos[index]["modo"] == "S":
				...
				if productos[index]["idProducto"] == "tarifaAT1" or productos[index]["idProducto"] == "tarifaAT2":
					...
					for x in xrange(0,item["cantidad"]):
							...
							id_producto = int(id_producto) + 1
							ct[modelo-1].showPage()
							genStamp("Tarifa D", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), ct[modelo-1])
							id_producto = int(id_producto) + 1
							ct[modelo-1].showPage()
