...
def genTicket(fecha_ticket, modo_ticket, modelo1_ticket, modelo2_ticket, items, id_cliente, nombre_maquina, productos, feria, lugar, empresa, cif, cp, l1, l2, l3, page_height, page_width, c):
	...
	#----------------- TRADUCCION 1/3
	drawTitle("Date", "FranklinGothicCondensed", 8, c2*mm - 22*mm, page_width, c)         #125
	...
	#----------------- TRADUCCION 2/3
	drawText("Product", "FranklinGothicCondensed", 8, 5*mm, c4*mm, c)                      #90
	drawText("Units", "FranklinGothicCondensed", 8, 45*mm, c4*mm, c)                        #90
	drawText("Price", "FranklinGothicCondensed", 8, 55*mm, c4*mm, c)                       #90
	drawText("Amount", "FranklinGothicCondensed", 8, 65*mm, c4*mm, c)                      #90
	...
	print id_cliente
	#----------------- TRADUCCION 3/3
	drawTitle("" + nombre_maquina +( " - Session ID: ") + id_cliente, "FranklinGothicCondensed", 9, 20*mm, page_width, c)
