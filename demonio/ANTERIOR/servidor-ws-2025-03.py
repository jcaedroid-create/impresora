...
def imprimir():
	...
	if os.path.getsize('stamp_simple_1_a.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_1 stamp_simple_1_a.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF")
	if os.path.getsize('stamp_simple_1_a2.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_1 stamp_simple_1_a2.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF")
	if os.path.getsize('stamp_simple_1_b.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_1 stamp_simple_1_b.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF")
	if os.path.getsize('stamp_simple_1_c.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_1 stamp_simple_1_c.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF")
