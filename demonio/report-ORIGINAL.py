...
def genTicket(fecha_ticket, modo_ticket, modelo1_ticket, modelo2_ticket, items, id_cliente, nombre_maquina, productos, feria, lugar, empresa, cif, cp, l1, l2, l3, page_height, page_width, c):
	...
	drawLogo("image2.jpg", 30*mm, 110*mm, page_width, c)
	drawTitle(feria, "FranklinGothicBold", 12, 125*mm, page_width, c)
	drawTitle(lugar, "FranklinGothicBold", 10, 125*mm - 6*mm, page_width, c)
	drawTitle(empresa, "FranklinGothicBold", 7.5, 125*mm - 10*mm, page_width, c)
	drawTitle(cif, "FranklinGothicBold", 7.5, 125*mm - 14*mm, page_width, c)
	drawTitle(cp, "FranklinGothicBold", 7.5, 125*mm - 18*mm, page_width, c)
	drawTitle("Fecha", "FranklinGothicCondensed", 8, 125*mm - 22*mm, page_width, c)
	drawTitle(fecha_ticket, "FranklinGothicCondensed", 8, 125*mm - 25*mm, page_width, c)

	drawText(modo_ticket, "FranklinGothicBold", 6.5, 5*mm, 95*mm, c)
	drawText("Producto", "FranklinGothicCondensed", 8, 5*mm, 90*mm, c)
	drawText("Cant.", "FranklinGothicCondensed", 8, 45*mm, 90*mm, c)
	drawText("Precio", "FranklinGothicCondensed", 8, 55*mm, 90*mm, c)
	drawText("Importe", "FranklinGothicCondensed", 8, 65*mm, 90*mm, c)
	drawLine(5*mm, 89*mm, page_width-2*5*mm, c)
	...
	drawLine(30*mm, 46*mm, page_width-30*mm - 5*mm, c)
	drawTotal(42*mm, str(totalProductos), str(totalImporte) + "€", c)
	...
	for index, item in enumerate(itemsColeccion):
		if items[index]["cantidad"]>0 and productos[index]["modo"] == "T":
			...
			for x in xrange(0,items[index]["cantidad"]):
				print item
				genTicket(fecha_ticket, modo_ticket, modelo1_ticket, modelo2_ticket, itemsColeccion, id_cliente, nombre_maquina, productos, feria, lugar, empresa, cif, cp, l1, l2, l3, page_height, page_width, c)
				c.showPage()
