...
def genTicket(fecha_ticket, modo_ticket, modelo1_ticket, modelo2_ticket, items, id_cliente, nombre_maquina, productos, feria, lugar, empresa, cif, cp, l1, l2, l3, page_height, page_width, c):
	...
	#----------------- TRADUCCION 3/4
	drawText("Produit", "FranklinGothicCondensed", 8, 5*mm, c4*mm, c)                      #90
	drawText("Qté", "FranklinGothicCondensed", 8, 45*mm, c4*mm, c)                        #90
	drawText("Prix", "FranklinGothicCondensed", 8, 55*mm, c4*mm, c)                       #90
	drawText("Montant", "FranklinGothicCondensed", 8, 65*mm, c4*mm, c)                      #90
	...
	print id_cliente
	#----------------- TRADUCCION 4/4
	drawTitle("" + nombre_maquina +( " - Session: ") + id_cliente, "FranklinGothicCondensed", 9, 20*mm, page_width, c)
