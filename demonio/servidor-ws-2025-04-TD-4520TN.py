...
def imprimir():
	...
	losprod=0
	# os.system("lp -d Brother_4520_1 stamp_simple_1_a2.pdf -o media=DC55x25 -o orientation-requested=6 -o Occurrence=Specified -o Interval=3") # LINEA 2 (FUNCIONA, OBLIGA A PEDIR 3)
	# os.system("lp -d Brother_4100_1 stamp_simple_1_c.pdf -o media=DC55x25 -o BrCutLabel=5 -o BrBiDiPrint=OFF") 
	# etiqueta 1
	if os.path.getsize('stamp_simple_1_a.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_1 stamp_simple_1_a.pdf -o media=DC55x25 -o orientation-requested=6") # LINEA 3 (FUNCIONA, CORTA DESPUÉS DE CADA TRABAJO ver LOCALHOST)
	if os.path.getsize('stamp_simple_1_a2.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_1 stamp_simple_1_a2.pdf -o media=DC55x25 -o orientation-requested=6") # LINEA 3 (FUNCIONA, CORTA DESPUÉS DE CADA TRABAJO ver LOCALHOST)
	if os.path.getsize('stamp_simple_1_b.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_1 stamp_simple_1_b.pdf -o media=DC55x25 -o orientation-requested=6") # LINEA 3 (FUNCIONA, CORTA DESPUÉS DE CADA TRABAJO ver LOCALHOST)
	if os.path.getsize('stamp_simple_1_c.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_1 stamp_simple_1_c.pdf -o media=DC55x25 -o orientation-requested=6") # LINEA 3 (FUNCIONA, CORTA DESPUÉS DE CADA TRABAJO ver LOCALHOST)
	# etiqueta 2

	if os.path.getsize('stamp_simple_2_a.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_2 stamp_simple_2_a.pdf -o media=DC55x25 -o orientation-requested=6")
	if os.path.getsize('stamp_simple_2_a2.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_2 stamp_simple_2_a2.pdf -o media=DC55x25 -o orientation-requested=6")
	if os.path.getsize('stamp_simple_2_b.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_2 stamp_simple_2_b.pdf -o media=DC55x25 -o orientation-requested=6")
	if os.path.getsize('stamp_simple_2_c.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4520_2 stamp_simple_2_c.pdf -o media=DC55x25 -o orientation-requested=6")
	...
	if os.path.getsize('ticket.pdf')>2000:
		...
		#NO: os.system("lp -d Brother_TD_4100N_T ticket.pdf -o media=Custom.78x", txtmedida ,"mm")	
			...
			os.system("lp -d Brother_T ticket.pdf -o media=Custom.78x142mm")
		else: 
