...
def genStampE2(tarifa, fecha, evento, codigo, c):
	pdfmetrics.registerFont(TTFont('FranklinGothic', 'franklin_gothic.ttf'))
	pdfmetrics.registerFont(TTFont('FranklinGothicBold', 'franklin_gothic_bold.ttf'))
	pdfmetrics.registerFont(TTFont('FranklinGothicCondensed', 'franklin_gothic_condensed.ttf'))
...
def genStampE3(tarifa, fecha, evento, codigo, c):
	pdfmetrics.registerFont(TTFont('FranklinGothic', 'franklin_gothic.ttf'))
	pdfmetrics.registerFont(TTFont('FranklinGothicBold', 'franklin_gothic_bold.ttf'))
	pdfmetrics.registerFont(TTFont('FranklinGothicCondensed', 'franklin_gothic_condensed.ttf'))
			...
			if TEmod1 == "S" or TEmod1 == "s":	
				...
				#	for x in xrange(0,vecesEspecial):
					...
					#	cte[modelo-1].showPage()
						genStampE1(genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
						id_producto = int(id_producto) + 1
						cte[modelo-1].showPage()
					# ETIQUETA 2
						genStampI(modelo1_ticket, "Tarifa A3", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
					...
					#	id_producto = int(id_producto) + 1
					#	cte[modelo-1].showPage()
						genStampE4(genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
						id_producto = int(id_producto) + 1
						cte[modelo-1].showPage()		
			...
			if TEmod2 == "S" or TEmod2 == "s":
				for x in range(vecesEspecial):
					...
					#	cte[modelo-1].showPage()
						...
						cte[modelo-1].showPage()
					# ETIQUETA 2
						genStampE2("Tarifa A3", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
						id_producto = int(id_producto) + 1
						cte[modelo-1].showPage()
					#	genStampE2(genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
					#	id_producto = int(id_producto) + 1
					#	cte[modelo-1].showPage()
					# ETIQUETA 3
						genStampE3("Tarifa A3", fecha_sello, evento_sello, genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
						id_producto = int(id_producto) + 1
						cte[modelo-1].showPage()
					#	genStampE3(genCodigo(modo_maquina, mes_maquina, pais_maquina, year_maquina, nombre_maquina, id_cliente, id_producto), cte[modelo-1])
					#	id_producto = int(id_producto) + 1
...
def printTickets(fecha_ticket, modo_ticket, modo_ticket_copia, modelo1_ticket, modelo2_ticket, items, id_cliente, nombre_maquina, productos, feria, lugar, empresa, cif, cp, l1, l2, l3, ImprimeCopiaTicket):
...
def afkarPrint(items, precios, id_cliente, id_producto, fecha_sello, evento_sello, fecha_ticket, modo_ticket, modo_ticket_copia, modelo1_ticket, modelo2_ticket, modo_maquina, nombre_maquina, mes_maquina, pais_maquina, year_maquina, feria, lugar, empresa, cif, cp, l1, l2, l3, T1especial, T2especial, T3especial, TEmod1, TEmod2, ImprimeCopiaTicket):
	...
	try:
		printTickets(fecha_ticket, modo_ticket, modo_ticket_copia, modelo1_ticket, modelo2_ticket, items, id_cliente, nombre_maquina, productos, feria, lugar, empresa, cif, cp, l1, l2, l3, ImprimeCopiaTicket)
