...
def imprimir():
	...
	if os.path.getsize('stamp_simple_2_a.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4100_2 stamp_simple_2_a.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF") 
	if os.path.getsize('stamp_simple_2_a2.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4100_2 stamp_simple_2_a2.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF") 
	if os.path.getsize('stamp_simple_2_b.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4100_2 stamp_simple_2_b.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF") 
	if os.path.getsize('stamp_simple_2_c.pdf')>2000:
		losprod=losprod+1
		os.system("lp -d Brother_4100_2 stamp_simple_2_c.pdf -o media=DC55x25 -o BrCutLabel=6 -o BrBiDiPrint=OFF") 
	...
	if os.path.getsize('stamp_tira_2_especial.pdf')>2000:
		os.system("lp -d Brother_4100_2 stamp_tira_2_especial.pdf -o media=DC55x25 -o BrCutLabel=4 -o BrBiDiPrint=OFF") 
	...
	if os.path.getsize('stamp_tira_2.pdf')>2000:
		losprod=losprod+2 #2
		os.system("lp -d Brother_4100_2 stamp_tira_2.pdf -o media=DC55x25 -o BrCutLabel=4 -o BrBiDiPrint=OFF") 
